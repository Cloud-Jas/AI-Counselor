...
using AICounsellorFrontend.Identity;
using AICounsellorFrontend.Components;
...
services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlite(connectionString, b => b.MigrationsAssembly(nameof(AICounsellorFrontend))));
